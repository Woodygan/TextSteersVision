...
class PaliGemmaWrapper:
    def __init__(
        ...
        model_name: str = "google/paligemma2-10b-mix-448",
        ...
        if self.model_name not in ["google/paligemma2-10b-mix-448", "google/paligemma2-3b-mix-448"]:
            raise ValueError("Model name must be 'google/paligemma2-10b-mix-448' or 'google/paligemma2-3b-mix-448'")
        ...
        if model is None:
            ...
            if model.config.model_type != "paligemma":
                raise ValueError("Model name does not match the provided model")
            self.model = model
...
class PaliGemmaLinearProbeManipulator(PaliGemmaWrapper):
    def __init__(
        self,
        device: str = "cuda",
        debug: bool = False,
    ...
    def create_image_mask(self, input_ids, masks: str = "image_token") -> torch.Tensor:
        ...
        """
        # Get the token IDs
        image_token_id = self.model.config.image_token_index  # 257152
        pad_token_id = self.model.config.pad_token_id  # 0
        begin_of_text_id = self.model.config.bos_token_id  # 2
        end_of_text_id = self.model.config.eos_token_id  # 1
...
if __name__ == "__main__":
    # Define paths to your linear probe weights and biases
    weight_paths = {
        11: "linear_probe_features/gemma-2-9b/spatial_relationship/layer_11_weights.pt",
        12: "linear_probe_features/gemma-2-9b/counting/layer_12_weights.pt",
        13: "linear_probe_features/gemma-2-9b/attribute/layer_13_weights.pt"
    }
    
    bias_paths = {
        11: "linear_probe_features/gemma-2-9b/spatial_relationship/layer_11_bias.pt",
        12: "linear_probe_features/gemma-2-9b/counting/layer_12_bias.pt",
        13: "linear_probe_features/gemma-2-9b/attribute/layer_13_bias.pt"
    }
    ...
    manipulator = PaliGemmaLinearProbeManipulator(
        debug=True,
